...
println(bisect(f1, 0.5, 2.0, delta, epsilon))
println(bisect(f2, -1.5, 0.5, delta, epsilon))

println(newton(f1, f1Prim, 0.0, delta, epsilon, 100))
println(newton(f2, f2Prim, -1.0, delta, epsilon, 100))

println(secant(f1, 0.5, 2.0, delta, epsilon, 100))
println(secant(f2, -1.5, 0.5, delta, epsilon, 100))
